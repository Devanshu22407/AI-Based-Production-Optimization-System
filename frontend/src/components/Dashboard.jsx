              ...
              <div className="glass-card p-5 lg:col-span-2">
                ...
                <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                  {machineEfficiency.slice(0, 3).map((item) => (
                    <div key={item.machine} className="rounded-lg border border-border bg-secondary/30 px-3 py-2 text-xs">
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button onClick={handleExportSchedule} className="rounded-md border border-border px-3 py-2 text-xs text-muted-foreground hover:bg-secondary/60">
                Export Schedule CSV
              </button>
              <button onClick={handleExportAnalytics} className="rounded-md border border-border px-3 py-2 text-xs text-muted-foreground hover:bg-secondary/60">
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex flex-1 flex-col overflow-hidden">
        <header className="flex h-14 flex-shrink-0 items-center justify-between border-b border-border bg-card/30 px-6 backdrop-blur-md">
          <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={refresh} className="flex h-8 w-8 items-center justify-center rounded-lg border border-border text-xs hover:bg-secondary/60">
              {isRefreshing ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <RefreshCw className="h-3.5 w-3.5" />}
            </button>
            <button className="relative flex h-8 w-8 items-center justify-center rounded-lg border border-border text-xs hover:bg-secondary/60">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          {connectionError && (
            <div className="mb-4 rounded-lg border border-destructive/40 bg-destructive/10 px-3 py-2 text-xs text-red-200">
